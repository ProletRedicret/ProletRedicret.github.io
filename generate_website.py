import os,sys
l={}
for a in os.walk(pa:='/media/a/be9d5105-e820-4780-ba68-742badace897/Prolet'):
    if'.git'in a[0]:continue
    if a[0]in l:continue
    f=['%s/%s'%(a[0],c)for c in os.listdir(a[0])if'.git'not in c]
...
<a class="url fn" rel="author" data-hovercard-type="user" data-hovercard-url="/users/ProletRevDicta/hovercard" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/ProletRevDicta">
ProletRevDicta</a></span>
<span class="mx-1 flex-self-stretch color-fg-muted">/</span>
<strong itemprop="name" class="mr-2 flex-self-stretch">
<a data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" href="<!--INDEX.HTM-->">Prolet</a>
</strong>
<span></span>
...
for a in l.keys():
    ...
    if a==pa:
        ...
        for b in la[1]:
            li.append('%s <a href="https://raw.githubusercontent.com/ProletRevDicta/Prolet/master/%s">%s</a>'%(fii,b[lp+1:],b.split('/')[-1]))
        li='\n<br>\n'.join(li)
...
l2.sort()
l2=['https://raw.githubusercontent.com/ProletRevDicta/Prolet/master/%s'%a for a in l2]
